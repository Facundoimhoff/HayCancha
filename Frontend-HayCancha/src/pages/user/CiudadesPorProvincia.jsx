...
import './CiudadesPorProvincia.css'; // Podés usar los mismos estilos de tus tarjetas
...
export default function CiudadesPorProvincia() {
  ...
  useEffect(() => {
    const cargarCiudades = async () => {
      try {
        setCargando(true);
        // Consultamos los clubes de esa provincia en Supabase para extraer las ciudades
        ...
        // Filtramos ciudades únicas para que no se repitan
